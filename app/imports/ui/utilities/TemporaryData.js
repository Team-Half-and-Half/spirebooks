...
// sample data to populate ManageProjections page table and render charts in CompareProjections
export const multipleChartData = [
  {
    id: 1,
    name: '2% Annual Growth Revenue Projection',
    data: [
  ...
  {
    id: 2,
    name: 'High Inflation Cost Forecast',
    data: [
  ...
  {
    id: 3,
    name: 'Shutdown Cash Flow Projection',
    data: [
